    ...
    <div class="row text-center text-center gx-4 gx-md-5" id="payment">
        <div class="col-md-4 mb-4">
            <div class="d-flex flex-column align-items-center">
                <i class="fa-solid fa-truck mb-3 fs-2 text-danger"></i>
        ...
        <div class="col-md-4 mb-4">
            <div class="d-flex flex-column align-items-center">
                <i class="fa-regular fa-credit-card mb-3 fs-2 text-danger"></i>
        ...
        <div class="col-md-4">
            <div class="d-flex flex-column align-items-center">
                <i class="fa-solid fa-rotate-left mb-3 fs-2 text-danger"></i>
    ...
    <div class="container">
        <div class="row gx-5 border-top border-bottom border-white py-5 ">
            ...
            <div class="col-md-4 mb-4 mb-md-0 border-end">
                <h5>Cosmetic & Jewellery Boutique</h5>
                <p class="mb-1">123 Glamour Avenue, Suite 101, New York, NY 10001, USA</p>
            ...
            <div class="col-md-4 mb-4 mb-md-0 text-center text-md-start">
                <h3 class="mb-3">
                    <i class="fa-solid fa-spa me-2 fs-3"></i>Glamour
                </h3>
                <p class="mb-4">
                Discover timeless beauty and elegance with our exclusive range of cosmetics and jewelry. Embrace luxury with every touch.                </p>
