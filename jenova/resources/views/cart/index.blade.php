        ...
        <div class="col col-12 col-md-9">
            ...
            <div class="row">
                <div class="col d-flex justify-content-start align-items-center gap-1 my-3"
                    role="button">
                    <a href="{{ route('shop.index') }}" class='text-decoration-none fw-bold text-danger'><i class="fa-solid fa-arrow-left"></i> Continue Shopping</a>
                </div>
            </div>
        </div>
        <div class="col col-12 col-md-3">
            ...
            <div class="card rounded-5 border-0 shadow">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('checkout.form') }}" class="btn btn-danger w-100 rounded-pill my-1">Proceed Checkout</a>
                </div>
            </div>
        </div>
    </div>
