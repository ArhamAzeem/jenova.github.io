...
<div class="container py-5">
    ...
    <div class="card shadow-sm mb-4 rounded-5 overflow-hidden">
        <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center p-4">
        ...
        <div class="card-body p-4">
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <p class="mb-2"><strong class="text-danger text-uppercase">{{ $order->payment_status }}</strong></p>
                </div>
                <div class="col-md-6">
                    <h6 class="text-muted">Delivery Status</h6>
                    <p class="mb-2"><strong class="text-danger text-uppercase">{{ $order->delivery_status }}</strong></p>
                </div>
            </div>
    ...
    <div class="text-end">
        <form action="{{ route('track.order.destroy', $order->order_number) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this order?');">
            @csrf
            @method('DELETE')
