                ...
                <div id="filterSection" class="collapse collapse-custom">
                    ...
                    <div class="border d-flex flex-column align-items-start rounded-4 p-3 mb-2 bg-body-secondary">
                        ...
                        <form action="{{ route('shop.index') }}" method="GET">
                            <div class="slider-container">
                                ...
                                <button type="submit"
                                    class="btn btn-danger mt-2 w-100 fw-bold fs-6 rounded-pill">Filter</button>
                            </div>
                        </form>
                    ...
                    <div class="border d-flex flex-column align-items-start rounded-4 p-3 mb-2 bg-body-secondary">
                        ...
                        <form action="{{ route('shop.index') }}" method="GET" class="flex-column d-flex gap-1">
                            ...
                            <div class="d-flex gap-1">
                                <input type="checkbox" name="category[]" value="cosmetic" id="cosmetic"
                                    onchange="this.form.submit()"
                                    {{ request()->has('category') && in_array('cosmetic', request()->category) ? 'checked' : '' }}>
                                <label for="cosmetic">Cosmetic</label>
                            </div>
                            <div class="d-flex gap-1">
                                <input type="checkbox" name="category[]" value="jewellery" id="jewellery"
                                    onchange="this.form.submit()"
                                    {{ request()->has('category') && in_array('jewellery', request()->category) ? 'checked' : '' }}>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li class="page-item disabled">
                            <span class="page-link text-danger bg-light border-danger">Previous</span>
                        </li>
                        @else
                        <li class="page-item">
                            <a class="page-link text-danger bg-light border-danger"
                        ...
                        <li class="page-item {{ $page == $products->currentPage() ? 'active' : '' }}">
                            <a class="page-link {{ $page == $products->currentPage() ? 'text-light bg-danger' : 'text-danger bg-light border-danger' }}"
                                href="{{ $url }}">
                                {{ $page }}
                            </a>
                        </li>
                        ...
                        @else
                        <li class="page-item disabled">
                            <span class="page-link text-danger bg-light border-danger">Next</span>
                        </li>
                        @endif
                    </ul>
                </nav>
